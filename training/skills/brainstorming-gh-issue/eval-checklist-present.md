...
- The criteria cover all major behaviours: issue resolution, re-entry detection, brainstorming handoff instructions, spec comment format, label management, Phase 5 file handling, and negative behaviours (no MCP, no premature posting).
...
- [ ] At least one criterion covers the Phase 4 handoff instruction to stop after step 8 and not invoke `writing-plans`.
...
- [ ] At least one negative criterion (e.g. "no MCP tool was called" or "Phase 5 ran `git rm`").
