...
The `report-bug` SKILL.md is reviewed for whether it documents the Claude Code shell expansion restriction correctly, so that agents executing the skill know not to use `${...}` syntax in bash commands.
