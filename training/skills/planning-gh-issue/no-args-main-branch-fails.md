...
The user runs `/planning-gh-issue` with no arguments. The current branch is `main`, which contains no digits.
...
- [ ] The error message contains the suggested invocation `/planning-gh-issue <N>`.
