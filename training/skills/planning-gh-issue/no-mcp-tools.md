...
The user runs `/planning-gh-issue 77`. MCP GitHub tools are available in the session. The issue has a valid spec comment.
...
- No `mcp__*` tools are called at any point during the skill execution.
