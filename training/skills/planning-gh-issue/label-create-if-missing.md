...
The user runs `/planning-gh-issue 61`. After plan approval, Phase 4 runs. The `pending-review` label does NOT exist on the repository.
...
- [ ] `gh label create "pending-review" --color "#FEF2C0" --description "Plan posted, awaiting human approval"` (or equivalent) is called.
