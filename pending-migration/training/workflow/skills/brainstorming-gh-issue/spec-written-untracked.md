...
- The Phase 3 handoff instructs brainstorming not to commit the spec file.
- Phase 4 locates the spec file using `ls -t docs/superpowers/specs/*.md | head -1`.
...
- Phase 4 deletes the local spec file with plain `rm` (not `git rm`).
