...
## Expected Behavior
The agent does not attempt to infer scope or begin reviewing files. It reports an error:
...
- [ ] The error message references the `reviewing-code-systematically` skill as the required dispatcher
- [ ] No findings, verdict, or summary table are produced
